"""Web Search Tentacle (Phase 3 / B).

Krakey's "look out the window" — fetches DuckDuckGo results and returns
them as a tentacle_feedback stimulus. Results are internal (is_internal=True);
