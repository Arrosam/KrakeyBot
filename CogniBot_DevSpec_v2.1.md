# CogniBot — 完整开发规格文档 v2.1

> **用途**：本文档是 CogniBot 项目的完整开发规格。开发工具（如 Codex）可仅依据本文档完成整个项目的实现。
>
...
CogniBot：以持续心跳维持"存在"的自主认知 Agent。用户交互是其认知活动的一部分而非全部。
...
**交付物**: CogniBot 从首次启动到自主 Sleep 到醒来后继续运行的完整生命周期。
